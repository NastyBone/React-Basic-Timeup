class Pomodoro extends React.Component {
  ...
  timeChamber() {
    ...
    if (!this.state.initialized) {
      ...
      if (this.state.sessionM < 10) {
        return '0' + this.state.sessionM + ":00";} else
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("span", null, "Session"), /*#__PURE__*/
      React.createElement("span", { id: "session-length" }, this.state.sessionM), /*#__PURE__*/
      React.createElement("span", { className: "fas fa-caret-down fa-4x control",
        id: "session-decrement" })), /*#__PURE__*/


      React.createElement("div", { id: "break-label" }, /*#__PURE__*/
      React.createElement("span", { className: "fas fa-caret-up fa-4x control",
        id: "break-increment" }), /*#__PURE__*/

      React.createElement("span", null, "Break"), /*#__PURE__*/
      React.createElement("span", { id: "break-length" }, this.state.breakM), /*#__PURE__*/
      React.createElement("span", { className: "fas fa-caret-down fa-4x control",
      ...
      React.createElement("h5", null, this.state.status), /*#__PURE__*/
      React.createElement("h2", { id: "time-left" }, this.timeChamber())), /*#__PURE__*/




      React.createElement("div", { id: "controls" }, /*#__PURE__*/
      React.createElement("span", { className: "fas fa-play fa-pause",
        id: "start_stop" }), /*#__PURE__*/
      React.createElement("audio", { id: "beep", src: "https://sampleswap.org/samples-ghost/SOUND%20EFFECTS%20and%20NOISES/Alarm%20Sounds/409[kb]nice-round-siren.wav.mp3" }), /*#__PURE__*/
      React.createElement("span", { className: "fas fa-redo",
        id: "reset" }))));
...
ReactDOM.render( /*#__PURE__*/React.createElement(Pomodoro, null), document.getElementById('clock'));
